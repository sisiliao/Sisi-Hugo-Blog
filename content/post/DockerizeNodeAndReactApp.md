---
title: 'Dockerize React and Node.JS App'
subtitle: 'Dockerization'
description: 'How to dockerize React and NodeJs app, and orchestrate the services using docker-compose'
date: 2021-01-05
author:      "Sisi"
image: ''
tags: ['Microservices', 'Docker', 'Docker-Compose', 'NodeJS', 'React']
categories: ['Cloud Technology']
---

# Dockerize React and Node.JS app, and orchestrate the services using docker-compose
